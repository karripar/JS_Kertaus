...
const greenIcon = L.icon({ // cool icons from the leaflet documentation, they actually look kinda annoying but oh well...
...
// your code here
const map = L.map('map').setView([60.2, 25], 11);

L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
  maxZoom: 18,
}).addTo(map); //cool graphics
...
restaurants.forEach(restaurant => {
  ...
  marker.bindPopup(`
    ...
    <p>${restaurant.address}, ${restaurant.city}</p>`); //popup information about the restaurant when clicked
});
